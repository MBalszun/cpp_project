...
// example command : cpp_project_generator.exe -N flat_map -t lib -T mba_flat_map -n mba -c MBa -m
// flat_map -g
int main( int argc, char** argv )
{
	try {
		UserConfig user_cfg = parse_config_clara( argc, argv );
		FullConfig full_cfg = generate_full_config( user_cfg );
		Config     cfg      = to_old_config( full_cfg ); 
